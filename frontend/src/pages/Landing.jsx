...
export default function Landing() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-navy-900 p-6 text-center">
      <div className="w-20 h-20 bg-royal-500 rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(37,99,235,0.5)] animate-pulse">
      ...
      <p className="text-navy-600 mb-12 max-w-md text-lg">The intelligent safety companion for women. Are you travelling today, or keeping an eye on someone?</p>
